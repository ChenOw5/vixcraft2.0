...
give @s egg[enchantment_glint_override=true,custom_name={"text":"Cryo Ring","italic": false,"color":"aqua"},lore=[{"text":"Summon a stationary Cyro Ring that lasts longer","italic":false},{"text":"25 Mana","italic":false}]] 1
give @s snowball[enchantment_glint_override=true,custom_name={"text":"Sheer Cold","italic": false,"color":"aqua"},lore=[{"text":"Perform an AOE attack in target direction","italic":false},{"text":"Deals double damage to freezed enemies","italic":false},{"text":"100 Mana","italic":false}]] 1
