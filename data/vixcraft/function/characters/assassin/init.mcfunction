...
give @s egg[enchantment_glint_override=true,custom_name={"text":"Dash Slash","italic": false,"color":"black"},lore=[{"text":"Dash towards target direction","italic":false},{"text":"Dealing damage will grant a ","italic":false},{"text":"reuse within 4s","italic":false},{"text":"12s CD","italic":false}]] 1
give @s snowball[enchantment_glint_override=true,custom_name={"text":"The Hunt","italic": false,"color":"black"},lore=[{"text":"Instantly enter Stealth","italic":false},{"text":"Killing an enemy reduces CD by 12.5s","italic":false},{"text":"25s CD","italic":false}]] 2
