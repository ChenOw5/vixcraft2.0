...
execute store result entity @s Motion[0] double 0.0125 run scoreboard players operation @s motion_x2 -= @s motion_x1
data modify entity @s Motion[1] set value 0.5d
execute store result entity @s Motion[2] double 0.0125 run scoreboard players operation @s motion_z2 -= @s motion_z1