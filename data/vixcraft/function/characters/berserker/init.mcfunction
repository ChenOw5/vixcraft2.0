...
give @s egg[enchantment_glint_override=true,custom_name={"text":"Inshout","italic": false,"color":"green"},lore=[{"text":"Use - deal damage to all enemies","italic":false},{"text":"Crouch Use - Taunt nearby enemies for 5s","italic":false},{"text":"16s CD","italic":false}]] 1
give @s snowball[enchantment_glint_override=true,custom_name={"text":"Ground Pound","italic": false,"color":"green"},lore=[{"text":"Perform a diving ground pound attack","italic":false},{"text":"Deals damage and knocks up nearby enemies on impact","italic":false},{"text":"18s CD","italic":false}]] 1
