...
give @s egg[enchantment_glint_override=true,custom_name={"text":"Pierce Arrows","italic": false,"color":"dark_blue"},lore=[{"text":"Enchance the next 3 shots","italic":false},{"text":"Enchanced Arrows pierce enemies","italic":false},{"text":"10s CD","italic":false}]] 1
give @s snowball[enchantment_glint_override=true,custom_name={"text":"Arrow Slaughter","italic": false,"color":"dark_blue"},lore=[{"text":"Recall all Enchanced Arrows","italic":false},{"text":"Dealing damage along the path","italic":false},{"text":"12s CD","italic":false}]] 1
give @s arrow 32
