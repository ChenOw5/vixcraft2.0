...
execute unless score @s hitscan matches 100.. unless entity @e[tag=shotgun,dx=0,dy=0,dz=0] positioned ^ ^ ^0.5 run function vixcraft:characters/shotgun/recall/recall
kill @s